					...
					<div className="about-me">
						...
						<div className="about-me__text">
							<p className="about-me__text__paragraph">
								Interesuję się&nbsp;najnowszymi trendami z&nbsp;zakresu tworzenia stron www, aplikacji
								webowych, blogów, etc. Jako developer skupiam się&nbsp;na&nbsp;zagadnieniach UI, UX oraz
								dbam o&nbsp;to, aby strony działały płynnie i&nbsp;były dostosowane do&nbsp;wyświetlania
								na&nbsp;każdym urządzeniu. W&nbsp;rozwijaniu swoich kompetencji koncentruję
								się&nbsp;głównie na&nbsp;technologiach front-endowych i&nbsp;w&nbsp;mniejszym stopniu
								na&nbsp;technologiach back-endowych. Do&nbsp;każdego projektu podchodzę indywidualnie.
								Stawiam na&nbsp;komunikację z&nbsp;klientem, znajdując najlepsze rozwiązania,
								spełniające jego potrzeby i&nbsp;umożliwiające dostarczenie projektu na&nbsp;czas.
							</p>
						</div>
					</div>
