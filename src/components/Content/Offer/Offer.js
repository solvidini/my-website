		...
		<section name="section-offer" className="section-offer">
			...
			<div className="offer-content">
				<div className="offer-content__item">
					...
					<p className="offer-content__item__description">{context.dictionary.offer.makingWebsites.description}</p>
				</div>
				<div className="offer-content__item">
					<img className="offer-content__item__image" src={responsive} alt="Responsywny design" />
					<h3 className="offer-content__item__title">{context.dictionary.offer.responsiveDesign.title}</h3>
					<p className="offer-content__item__description">{context.dictionary.offer.responsiveDesign.description}</p>
				</div>
				<div className="offer-content__item">
					<img className="offer-content__item__image" src={ui} alt="Intuicyjny interfejs" />
					<h3 className="offer-content__item__title">{context.dictionary.offer.intuitiveInterface.title}</h3>
					<p className="offer-content__item__description">{context.dictionary.offer.intuitiveInterface.description}</p>
				</div>
			</div>
		</section>
	);
