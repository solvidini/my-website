    ...
    <footer className="footer" name="section-contact">
      <div className="footer__top">
        ...
        <div className="footer__top__item">
          ...
          <span>contact@samuelk.pl<a href="mailto:contact@samuelk.pl" style={{fontSize: "1.8rem"}}> &rarr;</a></span>
          <span>samukedo@gmail.com<a href="mailto:samukedo@gmail.com" style={{fontSize: "1.8rem"}}> &rarr;</a></span>
        </div>
        <div className="footer__top__item">
          <h4>
